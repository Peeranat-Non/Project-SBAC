      ...
      <tbody>
        <?php foreach ($result as $row_dm) { ?>
          <tr>
            ...
            <td>
              <a class="btn btn-warning btn-sm" href="./type.php?act=edit&t_id=<?php echo $row_dm['t_id']; ?>">
                <i class="fas fa-pencil-alt">
                </i>
                แก้ไข
              </a>
              <a class="btn btn-danger btn-sm" href="./type_del.php?t_id=<?php echo $row_dm['t_id']; ?>" onclick="return confirm('ยืนยันการลบข้อมูล !');">
