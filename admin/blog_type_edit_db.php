<?php
      ...
      //sql update
      $stmt = $conn->prepare("UPDATE  tbl_blog_type SET t_name=:t_name, t_nameEN=:t_nameEN, StatusType=:StatusType WHERE t_id=:t_id");
        ...
        echo '<script>
             setTimeout(function() {
              swal({
                  ...
                  window.location = "blog_type.php"; //หน้าที่ต้องการให้กระโดดไป
              });
            }, 1000);
        </script>';
    }else{
