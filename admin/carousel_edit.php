 <?php
    if (isset($_GET['ID'])) {
        include 'condb.php';
        $stmt = $conn->prepare("SELECT* FROM tbl_slides WHERE ID=?");
 ...
 <div class="card card-info">
     ...
     <!-- /.card-header -->
     <div class="card-body">
         <form action="carousel_edit_db.php" method="POST" enctype="multipart/form-data">
             <div class="row">
                 <div class="col-sm-6">
                     <!-- text input -->
                     <div class="mb-3">
                         <label class="mb-2">ชื่อสไลด์</label>
                         <input type="text" name="slide_name" value="<?= $row['slide_name']; ?>" class="form-control" placeholder="กรอกข้อมูลชื่อสไลด์">
                     </div>
                 </div>
                 <div class="col-sm-6">
                     <!-- text input -->
                     <div class="mb-3">
                         ...
                         <input type="url" name="slide_link" value="<?= $row['slide_link']; ?>" required class="form-control" value="" minlength="5">
                     </div>
                 </div>
                 <div class="col-sm-6">
                     <!-- text input -->
