      ...
      <div class="row">
        <div class="col-sm-6">
          <div class="mb-3">
            ...
            <input type="text" name="Name" value="<?= $row['Name']; ?>" class="form-control is-warning" placeholder="กรอกข้อมูลชื่อเอกสาร">
          </div>
        </div>
        <div class="col-sm-6">
          <div class="mb-3">
      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="mb-3">
            ...
            <textarea type="text" name="Content" class="form-control" id="editor" rows="3" placeholder=""></textarea>
          </div>
        </div>
      </div>
      <!-- <div class="row">
