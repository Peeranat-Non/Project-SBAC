...
if (isset($_GET['ID'])) {
  include 'condb.php';
  $stmt = $conn->prepare("SELECT* FROM tbl_news WHERE ID=?");
...
<div class="card card-info">
  ...
  <div class="card-body">
    <form action="news_edit_db.php" method="POST" enctype="multipart/form-data">
      <div class="row">
        <div class="col-sm-6">
          <div class="mb-3">
            <label class="mb-2">ชื่อข่าวสาร</label>
            <input type="text" name="Name" value="<?= $row['Name']; ?>" class="form-control is-warning" placeholder="กรอกข้อมูลชื่อข่าวสาร">
          </div>
        </div>
        <div class="col-sm-6">
          <div class="mb-3">
            ...
            <select name="t_id" class="form-select" required>
              <option value="t_id">-เลือกประเภทข่าวสาร-</option>
              <?php
              include 'condb.php';
